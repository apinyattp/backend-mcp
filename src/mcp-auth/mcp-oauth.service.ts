...
export class McpOAuthService {
  constructor(
    ...
    this.store.saveClient({
      ...
      client_name: "Knowledge Hub MCP Client",
      redirect_uris: [],
  ...
  createAuthorizationCode(params: {
    ...
    // Allow any redirect_uri for pre-registered clients (empty redirect_uris = accept all)
    if (
  ...
  buildProtectedResourceMetadata(baseUrl: string): object {
    return {
      ...
      resource_name: "Knowledge Hub MCP Server",
    };
  }
